...
const HeroSection = () => {
  ...
  return (
    ...
    <div className="relative bg-cover bg-center h-96" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://www.tetris-db.com/wp-content/uploads/2024/03/tetrisdb-illus-services-build.jpg)' }}>
    <div className="absolute inset-0 z-10 flex flex-col pl-4 sm:pl-12 pt-2">
          <p className="text-white sm:text-sm text-xs font-bold pb-8 sm:pb-16">Home » Services » Fit-out services</p>
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-white mt-4 sm:mt-8">Making your design vision <br className="hidden sm:inline" />a reality</h1>
      </div>
    </div>
    ...
    <div className="lg:px-36 md:px-12 px-5 bg-black mt-24 grid md:grid-cols-2 grid-cols-1 gap-14 md:pb-28 pb-10 ">
        ...
        <div className="">
          <Image
            className=" w-full "
            height={460}
            src={'https://www.tetris-db.com/wp-content/uploads/2024/03/carre-build.jpg'}
...
<div className="text-white w-full md:w-2/3 pl-4 md:pl-24 text-xl">
          ...
          Fit-out works that deliver quality spaces
          </h2>
          <p className="md:mt-5 mt-3 text-sm">
...
<div className="flex justify-between sm:flex-row flex-col text-white p-4 md:p-24">
    ...
    <div className="relative flex justify-center items-center h-full py-8 mt-8">
        ...
        <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://www.tetris-db.com/wp-content/uploads/2021/11/tetrisdb-illus-texture-cta-15.jpg')`, filter: 'blur(4px)' }}></div>
        <div className="flex flex-col">
      <h1 className="flex z-10 pb-12 justify-center sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center text-white items-center">Why our fit-out services stand out</h1>
...
<div className=" h-full bg-cover bg-center items-center flex flex-col pt-12 mt-12 pl-12" style={{ backgroundImage: `url(${'https://www.tetris-db.com/wp-content/uploads/2022/10/tetrisdb-illus-texture-cta-35.jpg'})` }}>
    ...
    <div className="lg:px-36 md:px-12 px-5 bg-black mt-24 grid md:grid-cols-2 grid-cols-1 gap-14 md:pb-28 pb-10 ">
        ...
        <div className="text-white mt-8 ">
          ...
          How our fit-out works help businesses
          </h2>
          <p className="md:mt-5 mt-3 text-sm">
          Physical space profoundly influences how people work, think and live. Our workplace consultancy service helps us design spaces that align with your company’s unique culture and business needs.
          </p>
      ...
      <Image
        className="w-full"
        height={350}
        src={'https://www.tetris-db.com/wp-content/uploads/2023/08/tetris-db-natixis-porto-portugal-35046-muscat-01.jpg'}
        alt="Image description"
      />
...
<Qoutes/>
    ...
    <div className="mx-8 mt-24">
      <div
        ...
        style={{ backgroundImage: `url(${'https://www.tetris-db.com/wp-content/uploads/2022/02/tetrisdb-illus-texture-cta-21.jpg'})` }}
      >
