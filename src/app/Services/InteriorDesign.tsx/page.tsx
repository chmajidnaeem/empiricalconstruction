...
const HeroSection = () => {
  ...
  return (
   ...
   <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://www.tetris-db.com/wp-content/uploads/2024/03/tetrisdb-illus-services-design.jpg)",
        }}
      >
        <div className="absolute inset-0 z-10 flex flex-col pl-4 sm:pl-12 pt-2">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mt-4 sm:mt-8">
            ...
            Creative interior design <br className="hidden sm:inline" />that unlocks your business potential
          </h1>
        </div>
      </div>
    ...
    <div className="lg:px-36 md:px-12 px-5 bg-black mt-24 grid md:grid-cols-2 grid-cols-1 gap-14 md:pb-28 pb-10 ">
        ...
        <div className="">
          <Image
            className=" w-full "
            height={460}
            src={'https://www.tetris-db.com/wp-content/uploads/2022/11/tetris-db-jll-spain-32006-01-scaled.jpg'}
        ...
        <div className="text-white  text-xl ">
          ...
          Our world-class interior designers create iconic, innovative environments in line with your business objectives and local culture.
          </h2>
...
<div className="flex justify-between sm:flex-row flex-col text-white p-4 md:p-24">
    ...
    <div className="relative flex justify-center items-center h-full py-8 mt-8">
      ...
      <h1 className="flex z-10 pb-12 justify-center sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center text-white items-center">How our design services can help</h1>
...
<div
    ...
    <div className="lg:px-36 md:px-12 px-5 bg-black mt-24 grid md:grid-cols-2 grid-cols-1 gap-14 md:pb-28 pb-10 ">
        ...
        <div className="text-white mt-8 ">
          ...
          How our interior design expertise helps businesses
          </h2>
          <p className="md:mt-5 mt-3 text-sm">
          Physical space profoundly influences how people work, think and live. Our workplace consultancy service helps us design spaces that align with your company’s unique culture and business needs.
          </p>
      ...
      <Image
        className="w-full"
        height={350}
        src={'https://www.tetris-db.com/wp-content/uploads/2024/02/tetris-db-startway-partners-france-36128-7-730x450.jpg'}
        alt="Image description"
      />
...
<Qoutes/>
    ...
    <div className="mx-8 mt-24">
      <div
        ...
        style={{ backgroundImage: `url(${'https://www.tetris-db.com/wp-content/uploads/2021/05/tetrisdb-illus-texture-cta-3.jpg'})` }}
      >
        ...
        <div className="flex flex-col items-center justify-center absolute inset-0">
          <h1 className="text-5xl font-bold text-white text-center max-w-3xl">
            Our workplace consultancy can optimise how your business uses its space
          </h1>
