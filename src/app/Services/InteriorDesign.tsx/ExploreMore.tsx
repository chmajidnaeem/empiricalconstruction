...
export default function CaptionCarousel() {
  ...
  const cards = [
    {
      title: 'Office interior design that transforms workplaces',
      text: "Our global team of designers specialise in office interior design that enhances wellbeing, productivity and sustainability in the workplace.",
      image:
        'https://www.tetris-db.com/wp-content/uploads/2021/11/tetris-db_tdcx_barcelona-06.jpg',
    },
    {
...
Explore our commercial interior design services
            </h2>
      {/* Left Icon */}
      <IconButton
