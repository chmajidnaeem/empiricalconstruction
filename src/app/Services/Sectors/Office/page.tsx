...
const HeroSection = () => {
  ...
  return (
    ...
    <div className="relative bg-cover bg-center h-96" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://www.tetris-db.com/wp-content/uploads/2022/02/tetris-db-illus-offices-intro-v2.jpg)' }}>
      <div className="absolute inset-0 z-10 flex flex-col pl-12 pt-2">
        <p className="text-white sm:text-sm text-xs  font-bold pb-16">Home » Our Work »  Office</p>
       
        
        <h1 className="sm:text-5xl text-3xl font-bold text-white mt-8">Feelgood spaces that <br/>enrich how you work</h1>
      </div>
    </div>
...
<div className="mx-8 mt-24">
      <div
        ...
        style={{ backgroundImage: `url(${'https://www.tetris-db.com/wp-content/uploads/2024/04/fit-out-cost-guide-tetris-2024-1.jpg'})` }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50"></div> {/* Black overlay covering the image */}
        
        <div className="flex pl-8 pt-28 flex-col absolute inset-0">
          <h1 className="text-4xl font-bold text-white max-w-3xl">
          EMEA Fit-Out Cost Guide 2024
          </h1>
          <p  className="mt-4 text-white">
          Our index offers you a holistic picture of how fit-out decisions can affect
your bottom line.
          </p>
...
<div
      ...
      <div
        className="bg-cover bg-center h-96 relative"
        style={{ backgroundImage: `url(${'https://www.tetris-db.com/wp-content/uploads/2022/02/tetrisdb-illus-texture-cta-20.jpg'})` }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50"></div> {/* Black overlay covering the image */}
