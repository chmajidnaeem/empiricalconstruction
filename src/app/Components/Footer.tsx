  ...
  return (
    <Box bg={"black"} color={"white"}>
      <Container
        ...
        maxW={"6xl"}
        py={10}
        px={{ base: 20, md: 12, lg: 0 }}
        overflow={"hidden"}
      >
        <SimpleGrid
          templateColumns={{ sm: "1fr 1fr", md: "1fr 1fr 1fr ", lg: "1fr 1fr 1fr 1fr 1fr 1fr" }}
          spacing={8}
        >
          ...
          <Stack align={"flex-start"}>
            <ListHeader>
              <span className="text-[#C3C32F] text-sm"> Construction Series</span>
            </ListHeader>
            <Box as="a" href={"/Components/WhoWeAre"}>
              
            </Box>
            <Box as="a" href={"/Components/WhereToFindUs"}>
              Where to find us
            </Box>
            <Box as="a" href={"/Components/MeetTheTeam"}>
              Meet the team
            </Box>
            <Box as="a" href={"/Components/Sustainability"}>
              Sustainability
            </Box>
            <Box as="a" href={"/Insights"}>
              Insights & News
            </Box>
          </Stack>
          <Stack align={"flex-start"}>
            <ListHeader>
              <span className="text-[#C3C32F] text-sm">Services</span>
            </ListHeader>
            <Box as="a" href={"/Services"}>
              Design and Build
            </Box>
            <Box as="a" href={"/Services/WorkplaceConsultancy"}>
              WorkplaceConsultancy
            </Box>
            <Box as="a" href={"/Services/InteriorDesign"}>
             Enginering
            </Box>
            <Box as="a" href={"/Services/Fitoutservices"}>
              Fit-out services
            </Box>
            <Box as="a" href={"/Services/FurnitureSolutions"}>
              Marble Application
            </Box>
          </Stack>
          {/* <Stack align={"flex-start"}>
            <ListHeader>
              <span className="text-[#C3C32F] text-sm">Our Work</span>
            </ListHeader>
            {/* <Box as="a" href={"#"}>
              All ou Work
            </Box> */}
            {/* <Box as="a" href={"/Services/Sectors/Office"}>
              Office
            </Box>
            <Box as="a" href={"/Services/Sectors/Hotel"}>
              Hotel
            </Box>
            <Box as="a" href={"/Services/Sectors/Retail"}>
              Retail
            </Box> */}
          {/* </Stack> */} 
          <Stack align={"flex-start"}>
            <ListHeader>
              <span className="text-[#C3C32F] text-sm">other</span>
            </ListHeader>
            <Box as="a" href={"#"}>
          ...
          <Stack align={"flex-start"}>
            <ListHeader>We would love to hear from you</ListHeader>
            <Box as="a" href={"#"}>
              <Button
                borderRadius={0}
                px={{ base: "3", sm: "6" }}
            ...
            {/* <Box as="a" href={'#'}>
              Twitter
               ...
               <Box as="a" href={"empiricalconstruction77@gmail.com "}>
               empiricalconstruction77@gmail.com 
            </Box>
            <Box as="a" href={"empiricalconstruction77@gmail.com "}>
            Callus :  +303-306-4880
            ...
            <Box as="a" href={"empiricalconstruction77@gmail.com "}>
            Whatsapp :  0334-130-9459

            </Box>
         <div className="flex ">
         <SocialIcon  className="w-20 h-20 " url="https://www.tiktok.com/@empiricalconstruction77?is_from_webapp=1&sender_device=pc" />
            <SocialIcon  className="w-20 h-20 " url="https://www.youtube.com/@EmpiricalConstruction77" />
            <SocialIcon  className="w-20 h-20 " url="https://www.linkedin.com/in/empirical-construction/
" />
            <SocialIcon  className="w-20 h-20" url="https://www.instagram.com/empiricalconstruction77/" />
            <SocialIcon  className="w-20 h-20" url="https://www.facebook.com/profile.php?id=61557884517591" />
         </div>
          </Stack>
        </SimpleGrid>
      </Container>
