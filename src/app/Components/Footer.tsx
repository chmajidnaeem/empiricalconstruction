      ...
      >
        ...
        >
          ...
          <Stack align={"flex-start"}>
            ...
            <Box as="a" href={"empiricalconstruction77@gmail.com "}>
            Whatsapp :  111-111-1111

            </Box>
         <div className="flex ">
         <SocialIcon  className="w-20 h-20 " url="https://www.tiktok.com/" />
            <SocialIcon  className="w-20 h-20 " url="https://www.youtube.com/" />
            <SocialIcon  className="w-20 h-20 " url="https://www.linkedin.com/" />
            <SocialIcon  className="w-20 h-20" url="https://www.instagram.com/" />
            <SocialIcon  className="w-20 h-20" url="https://www.facebook.com/" />
         </div>
          </Stack>
        </SimpleGrid>
      </Container>
